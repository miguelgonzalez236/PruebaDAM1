...
// Inventario.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CInventarioApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CInventarioApp

CInventarioApp::CInventarioApp()
{
...
// El único objeto CInventarioApp

CInventarioApp theApp;


// Inicialización de CInventarioApp

BOOL CInventarioApp::InitInstance()
{
	...
	//dlg.SetBackgroundColor(RGB(200, 200, 280),1);
