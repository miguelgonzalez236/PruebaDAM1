...
El Asistente para aplicaciones ha creado esta aplicación Inventario.
...
constituyen su aplicación Inventario.
...
Inventario.cpp
    ...
    de la aplicación CInventarioApp.
...
InventarioDlg.h, InventarioDlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase CInventarioDlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en Inventario.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Inventario.pch y un archivo de 
